...
export async function analyzeInvoiceAction(
  ...
  const prompt = `
    ...
    لجميع الأصناف، استخرج الاسم (Name) والكمية (Qty) والسعر (Price) وفق القواعد التالية:
    - **السعر = المجموع الكلي للصنف كاملاً (الكمية × سعر الوحدة) وليس سعر الوحدة الواحدة.**
      مثال: إذا كان 8 لتر زيت بسعر 40 ريال للتر → السعر = 320 ريال (وليس 40).
      مثال: إذا كانت 4 كفرات بسعر 500 لكل كفر → السعر = 2000 ريال (وليس 500).
    - السعر يجب أن يكون دائماً **قبل الضريبة** (السعر الصافي بدون الـ 15%).
      إذا كان الإجمالي المكتوب يشمل الضريبة فاقسمه على 1.15 للحصول على السعر قبل الضريبة.
    - إذا كان السعر المكتوب في الفاتورة هو إجمالي الصنف (كمية × سعر وحدة) فاستخدمه مباشرة بعد التأكد من كونه قبل الضريبة.
