...
export async function analyzeInvoiceAction(
  ...
  const prompt = `
    ...
    4. حقل "itemsDescription" (وصف الأصناف): استخرج الأصناف على شكل قائمة مرقمة تبدأ بالرقم ثم شرطة ثم اسم الصنف (مثل: 1- صنف أ، 2- صنف ب) وضع كل صنف في سطر جديد. تأكد أن الرقم في بداية السطر.
